        ...
        <div id="full">
            ...
            <div class="profileaction">
                ...
                <div class="profiledetails">
                    <h3 style="text-align: center;margin-top: 10px;">Saved Address</h3>
                    <div class="prodetail_btnaddress"><a Style="color: white;line-height: 2em;text-decoration: none" href="Profile_updatedetails.jsp">Add Address</a></div>
                    <div class="prodetail_btnchgpass"><a Style="color: white;line-height: 2em;text-decoration: none" href="Profile_changepassword.jsp">Change Password</a></div>
                </div>
            </div>
